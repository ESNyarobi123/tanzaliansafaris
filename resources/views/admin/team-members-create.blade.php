...
<div class="page-header">
    <h1><i class="fas fa-user-plus" style="color: var(--primary-600); margin-right: 12px;"></i>Add Team Member</h1>
    <p>Create a new team member profile to display on your website.</p>
</div>
    ...
    <form action="{{ route('admin.team-members.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="position" id="position" class="form-control" value="{{ old('position') }}" placeholder="e.g. Senior Guide" required>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="role" id="role" class="form-control" value="{{ old('role') }}" placeholder="e.g. Birding Expert">
            </div>
            <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="bio" id="bio" class="form-control" placeholder="Brief description about the team member...">{{ old('bio') }}</textarea>
        </div>

        <div class="form-row">
            <div class="form-group">
                <label for="specialties">Specialties (comma separated)</label>
                <input type="text" name="specialties" id="specialties" class="form-control" value="{{ old('specialties') }}" placeholder="e.g. Big Five, Birding, Photography">
                <p class="help-text">Separate multiple specialties with commas</p>
            </div>
            <div class="form-group">
                <label for="languages">Languages (comma separated)</label>
                <input type="text" name="languages" id="languages" class="form-control" value="{{ old('languages') }}" placeholder="e.g. English, Swahili, French">
        ...
        <div class="form-group">
            ...
            <p class="help-text">Recommended size: 400x400px. Max 2MB.</p>
            <img id="image-preview" class="image-preview" style="display: none;">
        </div>

        <div class="btn-group">
            <button type="submit" class="btn-submit">
                <i class="fas fa-save" style="margin-right: 8px;"></i>Save Member
            </button>
